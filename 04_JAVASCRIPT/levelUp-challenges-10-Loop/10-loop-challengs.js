...
*/
let ofTeas = ["chai", "green tea", "herbal tea", "black tea"];
let preferredTeas = [];

for (const tea of ofTeas) {
    if (tea === "herbal tea") {
        continue;
    }
...
8. Write a 'forEach' loop that iterates through the array ["Berlin", "Tokyo", "Sydney", "Paris"].
    Skip "Sydney" and store other cities in a new array named 'travelledCities'.
*/
let worldsCities = ["Berlin", "Tokyo", "Sydney", "Paris"];
let travelledCities = [];

worldsCities.forEach(function(c) {
    if (c == "Sydney") {
        return;
    }
